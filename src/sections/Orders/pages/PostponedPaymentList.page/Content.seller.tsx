...
import PostponedPaymentModalSeller from 'sections/Orders/components/PostponedPaymentModalSeller';
...
const PostponedPaymentListPageContentSeller: FC<IProps> = ({
  postponedPayments,
}) => {
            ...
            cols: [
              {
                content: (
                  <span className="text-bold text-underline text-left">
                    ...
                    <br />
                    ИНН {item.customerOrganization.inn}
                  </span>
                ),
              },
              {
...
export default PostponedPaymentListPageContentSeller;
